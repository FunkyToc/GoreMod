...
execute if score McVersion fktool matches ..11400 as @a at @s run function goremod:execution/entities/track_entities_1.13
execute if score McVersion fktool matches 11500.. as @a at @s run function goremod:execution/entities/track_entities_1.15
