...
execute as @s[type=minecraft:trader_llama] run function goremod:execution/tracking
execute as @s[type=minecraft:wandering_trader] run function goremod:execution/tracking