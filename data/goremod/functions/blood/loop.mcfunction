...
# Blood particule
execute if score McVersion GM_Options matches 113 as @e[type=!player,type=!item,tag=blood] at @s run function goremod:blood/bloodentity_1.13
execute if score McVersion GM_Options matches 114 as @e[type=!player,type=!item,tag=blood] at @s run function goremod:blood/bloodentity_1.14
execute if score McVersion GM_Options matches 115 as @e[type=!player,type=!item,tag=blood] at @s run function goremod:blood/bloodentity_1.15
